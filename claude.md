...
- **Todo → `TODO.md` o issue GitHub** (sorgente unica). Non sparpagliare TODO nei commenti.
- **Verificare i test** prima di commit: `npm run test` deve passare completamente.
